...
const eventTypeLabels = computed(() => ({
  ...
  automation_handoff_completed: t(
    'IBSOFT_THEME.CONVERSATION_DISTRIBUTION.EVENT_LOGS.EVENT_TYPES.AUTOMATION_HANDOFF_COMPLETED'
  ),
  automation_close_completed: t(
    'IBSOFT_THEME.CONVERSATION_DISTRIBUTION.EVENT_LOGS.EVENT_TYPES.AUTOMATION_CLOSE_COMPLETED'
  ),
  automation_close_warning_sent: t(
    'IBSOFT_THEME.CONVERSATION_DISTRIBUTION.EVENT_LOGS.EVENT_TYPES.AUTOMATION_CLOSE_WARNING_SENT'
  ),
  automation_close_cancelled: t(
    'IBSOFT_THEME.CONVERSATION_DISTRIBUTION.EVENT_LOGS.EVENT_TYPES.AUTOMATION_CLOSE_CANCELLED'
  ),
  automation_handoff_skipped: t(
    'IBSOFT_THEME.CONVERSATION_DISTRIBUTION.EVENT_LOGS.EVENT_TYPES.AUTOMATION_HANDOFF_SKIPPED'
  ),
...
const reasonLabels = computed(() => ({
  ...
  customer_replied: t(
    'IBSOFT_THEME.CONVERSATION_DISTRIBUTION.EVENT_LOGS.REASONS.CUSTOMER_REPLIED'
  ),
  conversation_changed: t(
    'IBSOFT_THEME.CONVERSATION_DISTRIBUTION.EVENT_LOGS.REASONS.CONVERSATION_CHANGED'
  ),
  warning_delivery_failed: t(
    'IBSOFT_THEME.CONVERSATION_DISTRIBUTION.EVENT_LOGS.REASONS.WARNING_DELIVERY_FAILED'
  ),
